...
var _uploadFunctionAsync = function (lambdaFunc, config) {
    ...
    var params = {
        FunctionName: handlerName.concat('-', functionMD5), // TODO Find a better way to name functions?
        FunctionZip: zipData, // TODO Zip function
...
exports.create = function(func, config) {
    ...
    var proxy = function () {
        ...
        uploadPromise.catch(function(err) {
            throw "Could not uplaod function to Amazon S3: " + err;
        });
