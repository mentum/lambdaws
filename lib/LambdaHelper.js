...
var _lambdaize = function (userFunc) {
    function __lambda__ (event, context) {
        console.log('ENTERED MODULE FUNCTION');
        ...
        console.log('SQS CREATED', context);
...
var _lambdaizeModule = function(handlerName) {
    ...
    var outputModuleCode = "console.log('ENTERED MODULE');var m = require('./module.js')" + functionToCall + ";console.log('REQUIRED MODULE');";
