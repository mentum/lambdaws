    ...
    this.getCloudedFunctionFromModule = function(modulePath, handlerName, deps, configs) {
        ...
        if(!proxyStore.hasOwnProperty(functionIdentifier)) {
            ...
            if(typeof(handlerName) === 'string') {
                ...
                handlerName = 'default';
                _moduleOverride = "var m = require('./module.js');exports." + handlerName + " = m;";
            }
            ...
            if(typeof(_moduleOverride) === 'undefined') {
                _addFileToZipNode('index.js', modulePath, zipFile);
            } else {
            ...
            proxyStore[functionIdentifier] = functionIdentifier;
        }
